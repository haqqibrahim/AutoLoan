...
def run():
    ...
    gen_display = ('Male','Female')  # Display options for gender
    ...
    if st.button("Submit"):
        ...
        lc = [str(i) for i in prediction]  # Convert prediction to string
        ans = int("".join(lc))  # Join and convert to integer (0 or 1)
